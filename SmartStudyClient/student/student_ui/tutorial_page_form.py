# Form implementation generated from reading ui file 'tutorial_page.ui'
#
...
class Ui_tutorial_page(object):
    ...
    def rect(self, tutorial_page, width, height, thickness):        
        objects = self.data['parameters'][tutorial_page.index]['objects']
        if objects == []:
            self.repeat_animation_btn.setHidden(True)
            return []
        texts = self.data['parameters'][tutorial_page.index]['texts']
        animation_list=[]
        maximum_size_x = 0
        maximum_size_y = 0
        for name in objects:
    ...
    def tutorial(self, tutorial_page):        
        if self.data == {}:
            return
        ...
        self.menu_label.setText(_translate("tutorial_page", tutorial_page.topic_name))
        ...
        self.tutorial_page_vertical_layout.removeWidget(self.desc_group_box)
        
        self.desc_group_box = QtWidgets.QGroupBox(parent=tutorial_page)
        self.desc_group_box.setStyleSheet("border:none;")
        self.desc_group_box.setTitle("")
        self.desc_group_box.setObjectName("desc_group_box")

        self.desc_vertical_layout = QtWidgets.QVBoxLayout(self.desc_group_box)
        self.desc_vertical_layout.setContentsMargins(0, 0, 0, 0)
        self.desc_vertical_layout.setSpacing(round(self.static["layout-spacing"]/2))
        self.desc_vertical_layout.setObjectName("desc_vertical_layout")

        match tutorial_page.window_size_index:
            case 0:
        ...
        #self.animation_list = self.rect(tutorial_page, width, height, 2)
        self.rect(tutorial_page, width, height, 2)

        """for i in self.animation_list:
            i.start()"""
        self.view = QtWidgets.QGraphicsView(self.scene)#, parent=self.scene_group_box)
        self.view.setMinimumSize(width, height)

        #self.view.setRenderHint(QtGui.QPainter.RenderHint.Antialiasing)


        self.desc_vertical_layout.addWidget(self.view)

        self.question_group_box = QtWidgets.QGroupBox(parent=self.desc_group_box)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.question_horizontal_layout.addItem(spacerItem1)
        self.question_label = QtWidgets.QLabel(self.data['description'][tutorial_page.index]["question"], parent=self.question_group_box)
        font = QtGui.QFont()
        font.setPointSize(self.static["font-sizes"]["text"])
        self.question_label.setFont(font)
        self.question_label.setWordWrap(True)
        self.question_label.setMinimumSize(QtCore.QSize(self.static["topic"]["desc-width"]*2, self.static["topic"]["height"]))
        self.question_label.setObjectName("question_label")
        self.question_horizontal_layout.addWidget(self.question_label)

        spacerItem2 = QtWidgets.QSpacerItem(100, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.question_horizontal_layout.addItem(spacerItem2)
        self.desc_vertical_layout.addWidget(self.question_group_box)

        self.description_group_box = QtWidgets.QGroupBox(parent=self.desc_group_box)
        #self.description_group_box.setMinimumSize(QtCore.QSize(720, 45))
        self.description_group_box.setStyleSheet("border:none")
        self.description_group_box.setTitle("")
        self.description_group_box.setObjectName("description_group_box")
        self.desc_horizontal_layout = QtWidgets.QHBoxLayout(self.description_group_box)
        self.desc_horizontal_layout.setContentsMargins(0, 10, 0, 10)
        self.desc_horizontal_layout.setObjectName("desc_horizontal_layout")
        
        spacerItem1 = QtWidgets.QSpacerItem(20, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.desc_horizontal_layout.addItem(spacerItem1)

        self.description_label = QtWidgets.QLabel(self.data['description'][tutorial_page.index]["method"], parent=self.description_group_box)
        font = QtGui.QFont()
        font.setPointSize(self.static["font-sizes"]["text"])
        self.description_label.setFont(font)
        self.description_label.setWordWrap(True)
        self.description_label.setMinimumSize(QtCore.QSize(self.static["topic"]["desc-width"]*2, self.static["topic"]["height"]))
        self.description_label.setObjectName("description_label")
        self.desc_horizontal_layout.addWidget(self.description_label)
        ...
        self.desc_horizontal_layout.addItem(spacerItem2)
        self.desc_vertical_layout.addWidget(self.description_group_box)

        self.answer_group_box = QtWidgets.QGroupBox(parent=self.desc_group_box)
        ...
        self.answer_label = QtWidgets.QLabel(self.data['description'][tutorial_page.index]["answer"], parent=self.answer_group_box)        
        font = QtGui.QFont()
        font.setPointSize(self.static["font-sizes"]["text"])
        self.answer_label.setFont(font)
        self.answer_label.setObjectName("answer_label")
        self.answer_label.setWordWrap(True)
        self.answer_label.setMinimumSize(QtCore.QSize(self.static["topic"]["desc-width"]*2, self.static["topic"]["height"]))
        ...
        self.desc_vertical_layout.addWidget(self.answer_group_box)
        
        self.next_group_box = QtWidgets.QGroupBox(parent=self.desc_group_box)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.next_group_box.sizePolicy().hasHeightForWidth())
        self.next_group_box.setSizePolicy(sizePolicy)
        self.next_group_box.setStyleSheet("border: none")
        self.next_group_box.setTitle("")
        self.next_group_box.setObjectName("next_group_box")

        self.next_horizontal_layout = QtWidgets.QHBoxLayout(self.next_group_box)
        self.next_horizontal_layout.setContentsMargins(0, 0, 0, 40)
        self.next_horizontal_layout.setSpacing(0)
        self.next_horizontal_layout.setObjectName("next_horizontal_layout")

        spacerItem3 = QtWidgets.QSpacerItem(301, 42, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.next_horizontal_layout.addItem(spacerItem3)

        self.next_btn = QtWidgets.QPushButton(parent=self.next_group_box)
        ...
        self.next_btn.setStyleSheet("QPushButton {background-color: #D9F2D0; border: 2px solid black; border-radius:10; padding-left:20px;padding-right:20px;}\n"
        ...
        self.next_horizontal_layout.addWidget(self.next_btn)
        self.next_btn.setText(_translate("tutorial_page", "Tovább"))
        self.next_btn.clicked.connect(tutorial_page.next)

        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.next_horizontal_layout.addItem(spacerItem4)

        self.desc_vertical_layout.addWidget(self.next_group_box)

        self.tutorial_page_vertical_layout.addWidget(self.desc_group_box)

        QtCore.QMetaObject.connectSlotsByName(tutorial_page)

    def setupUi(self, tutorial_page):
        tutorial_page.setObjectName("tutorial_page")
        tutorial_page.resize(720, 484)
        tutorial_page.setMinimumSize(QtCore.QSize(720, 480))
        ...
        tutorial_page.setPalette(palette)

        self.tutorial_page_vertical_layout = QtWidgets.QVBoxLayout(tutorial_page)
        self.tutorial_page_vertical_layout.setContentsMargins(0, 0, 0, 0)
        self.tutorial_page_vertical_layout.setSpacing(10)
        self.tutorial_page_vertical_layout.setObjectName("tutorial_page_vertical_layout")

        self.menu_group_box = QtWidgets.QGroupBox(parent=tutorial_page)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tutorial_page_vertical_layout.addWidget(self.menu_group_box)
        self.title_group_box = QtWidgets.QGroupBox(parent=tutorial_page)
        ...
        self.tutorial_label = QtWidgets.QLabel(parent=self.title_group_box)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.tutorial_label.sizePolicy().hasHeightForWidth())
        self.tutorial_label.setSizePolicy(sizePolicy)
        self.tutorial_label.setMinimumSize(QtCore.QSize(140, 30))
        font = QtGui.QFont()
        font.setPointSize(self.static["font-sizes"]["subtitle"])
        self.tutorial_label.setFont(font)
        self.tutorial_label.setStyleSheet("")
        self.tutorial_label.setObjectName("tutorial_label")
        self.title_horizontal_layout.addWidget(self.tutorial_label)
        ...
        self.tutorial_page_vertical_layout.addWidget(self.title_group_box)
        ...
        self.desc_vertical_layout = QtWidgets.QVBoxLayout(self.desc_group_box)
        self.desc_vertical_layout.setContentsMargins(0, 0, 0, 0)
        self.desc_vertical_layout.setSpacing(5)
        self.desc_vertical_layout.setObjectName("desc_vertical_layout")

        self.openGLWidget = QtOpenGLWidgets.QOpenGLWidget(parent=self.desc_group_box)
        ...
        self.desc_vertical_layout.addWidget(self.openGLWidget)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(326, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.desc_horizontal_layout.addItem(spacerItem1)

        self.description_label = QtWidgets.QLabel(parent=self.description_group_box)
        font = QtGui.QFont()
        font.setPointSize(self.static["font-sizes"]["text"])
        self.description_label.setFont(font)
        self.description_label.setWordWrap(True)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(326, 20, QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.desc_horizontal_layout.addItem(spacerItem2)
        self.desc_vertical_layout.addWidget(self.description_group_box)
...
"QPushButton:hover {background-color: #55aa00; border: 2px solid black; border-radius:10; padding-left:20px;padding-right:20px;}")
        ...
        match tutorial_page.user_settings['font-size']:
            case 'small':
    ...
    def retranslateUi(self, tutorial_page):
        _translate = QtCore.QCoreApplication.translate
        tutorial_page.setWindowTitle(_translate("tutorial_page", "SmartStudy"))
        self.menu_label.setText(_translate("tutorial_page", tutorial_page.topic_name))
        self.font_size_combo_box.setItemText(0, _translate("tutorial_page", "Kis betűméret"))
        self.font_size_combo_box.setItemText(1, _translate("tutorial_page", "Közepes betűméret"))
        self.font_size_combo_box.setItemText(2, _translate("tutorial_page", "Nagy betűméret"))
        self.back_to_topics_cmd_link_btn.setText(_translate("tutorial_page", "Vissza a szintekhez"))
        self.tutorial_label.setText(_translate("tutorial_page", "Oktató anyag"))
        self.next_btn.setText(_translate("tutorial_page", "Tovább"))
